...
def addImgItem(file_name, size):
    ...
    image_id = file_name # int(file_name.split(".")[0])
    # image_id += 1
    image_item = dict()
    ...
    for _id in ids:
        ...
        for elem in root:
            ...
            if elem.tag == 'filename':
                file_name = elem.text
                # xml文件中的文件名和实际存储时名称不一致，要对xml文件中的filename进行修改；
                file_name = _id+".jpg"
...
if __name__ == '__main__':
    # 通过txt文件生成
    voc_data_dir="F:/Datasets/VOCdevkit/VOC2007"
    json_save_path="F:/Datasets/VOCdevkit/voc2007test.json"
    parseXmlFiles_by_txt(voc_data_dir,json_save_path,"test")
    voc_data_dir="F:/Datasets/VOCdevkit/VOC2007"
    json_save_path="F:/Datasets/VOCdevkit/voc2007train.json"
    parseXmlFiles_by_txt(voc_data_dir,json_save_path,"train")

    # 通过文件夹生成
    # ann_path = "F:/Datasets/VOCdevkit/VOC2007/Annotations"
    # json_save_path = "F:/Datasets/VOCdevkit/test.json"
